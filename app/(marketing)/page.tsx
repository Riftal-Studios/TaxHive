...
export const metadata: Metadata = {
  ...
  title: "TaxHive - GST-Compliant Invoice Management for Indian Freelancers",
  description:
  ...
  openGraph: {
    ...
    description: "GST-compliant invoicing for Indian freelancers",
...
export default function LandingPage() {
  ...
  const websiteSchema = {
    ...
    name: "TaxHive",
    url: "https://taxhive.app",
    description: "GST-Compliant Invoice Management for Indian Freelancers",
    potentialAction: {
      "@type": "SearchAction",
    ...
    <>
      ...
      <div className="landing-page">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-gray-900 dark:text-gray-50">
                  GST-Compliant Invoicing for Indian Freelancers
                </h1>
                <p className="text-xl md:text-2xl mb-8 text-gray-600 dark:text-gray-300">
                  Professional invoice management for export businesses.
                  Generate GST Rule 46 compliant invoices with LUT declarations
                  and RBI exchange rates in seconds.
                </p>
                ...
                <div className="flex flex-wrap justify-center lg:justify-start gap-6 text-sm text-gray-600 dark:text-gray-400">
                  <TrustBadge
                    icon={
                      <svg
                        className="w-5 h-5 mr-2 text-emerald-500 flex-shrink-0"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
        ...
        <CTASection
          ...
          description="Join hundreds of Indian freelancers using TaxHive"

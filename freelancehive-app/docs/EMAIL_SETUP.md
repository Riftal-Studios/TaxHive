# Email Configuration for GSTHive
...
EMAIL_FROM="GSTHive <no-reply@gsthive.com>"
```
...
2. **Verified Domain/Email**: The sender email address (no-reply@gsthive.com) must be verified in Amazon SES.
...
fly secrets set EMAIL_FROM="GSTHive <no-reply@gsthive.com>"
```
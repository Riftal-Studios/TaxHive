 ...
 */
function loadSecret(secretName, envVarName) {
...
// Log successful initialization (without exposing secrets)
Logger.info('Application initialized with Docker secrets support')

module.exports = { loadSecret, loadAllSecrets }